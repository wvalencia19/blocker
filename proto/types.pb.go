...
type Version struct {
	...
	ListedAddr string   `protobuf:"bytes,3,opt,name=listedAddr,proto3" json:"listedAddr,omitempty"`
...
func (x *Version) GetListedAddr() string {
	if x != nil {
		return x.ListedAddr
	}
	return ""
...
type TxInput struct {
	...
	// the previous transaction hash containing the
...
var file_proto_types_proto_rawDesc = []byte{
	...
	0x12, 0x1e, 0x0a, 0x0a, 0x6c, 0x69, 0x73, 0x74, 0x65, 0x64, 0x41, 0x64, 0x64, 0x72, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6c, 0x69, 0x73, 0x74, 0x65, 0x64, 0x41, 0x64, 0x64, 0x72,
	...
	0x4e, 0x6f, 0x64, 0x65, 0x12, 0x1f, 0x0a, 0x09, 0x48, 0x61, 0x6e, 0x64, 0x53, 0x68, 0x61, 0x6b,
	...
	0x5a, 0x24, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x77, 0x76, 0x61,
	0x6c, 0x65, 0x6e, 0x63, 0x69, 0x61, 0x31, 0x39, 0x2f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x72,
